...
public static class Program {
  ...
  private static readonly string[] UsageText = {
    ...
    " -DependencyFrameworks <target-framework-list>",
    "                        Only consider dependencies for a specific set of target frameworks.",
    " -IncludeDependencies <mode>",
    "                        With mode 'BestMatch', only the best matching version will be",
    "                        imported. With mode 'All', all matching versions will be imported;",
    "                        be aware that most NuGet dependencies are specified open-ended, so",
    "                        this can result in a large number of imports. With mode 'None' (the",
    "                        default), no dependencies are imported automatically.",
    " -IncludePrerelease     When specified, prerelease package versions are also considered",
